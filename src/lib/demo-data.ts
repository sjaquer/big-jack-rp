...
// Función helper para crear objetos tipo Timestamp compatibles
  ...
  for (let daysAgo = 0; daysAgo < 30; daysAgo++) {
    ...
    for (let i = 0; i < ordersCount; i++) {
      ...
      sales.push({
        ...
        totalAmount: subtotal - (Math.random() > 0.85 ? Math.floor(subtotal * 0.1) : 0),
...
export const DEMO_ONLINE_ORDERS = [
  {
    ...
    items: [
      { productId: 'prod-002', productName: 'Hamburguesa Big Jack', quantity: 2, price: 28.90, unitPrice: 28.90 },
      { productId: 'prod-004', productName: 'Papas Fritas', quantity: 2, price: 8.90, unitPrice: 8.90 },
    ],
    total: 75.60,
    totalAmount: 75.60,
    status: 'pending',
  ...
  },
  {
    ...
    items: [
      { productId: 'prod-009', productName: 'Combo Big Jack', quantity: 1, price: 38.90, unitPrice: 38.90 },
      { productId: 'prod-008', productName: 'Milkshake Chocolate', quantity: 1, price: 14.90, unitPrice: 14.90 },
    ],
    total: 53.80,
    totalAmount: 53.80,
    status: 'preparing',
  ...
  },
  {
    ...
    items: [
      { productId: 'prod-010', productName: 'Combo Familiar', quantity: 1, price: 79.90, unitPrice: 79.90 },
    ],
    total: 79.90,
    totalAmount: 79.90,
    status: 'ready',
