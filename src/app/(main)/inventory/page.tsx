  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 pb-3">
          <h1 className="text-2xl lg:text-3xl font-headline font-bold">Gestion de Inventario</h1>
          <p className="text-sm text-muted-foreground">Supervisa y gestiona los niveles de stock de todos los articulos.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 pb-2">
                      ...
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="text-right">
                          <Button
                            variant="outline"
                            size="default"
                            className="h-10 sm:h-9 text-sm sm:text-xs touch-manipulation"
          ...
          <Card className="flex flex-col">
            <CardHeader className="flex-shrink-0 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
              <div>
                <CardTitle className="font-headline text-base sm:text-lg">Otros Articulos</CardTitle>
