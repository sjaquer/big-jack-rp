      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto w-full px-3 sm:px-6 py-4 sm:py-6 space-y-5">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl lg:text-4xl font-headline font-bold text-slate-900 tracking-tight">Flujo de Caja</h1>
            <p className="text-base text-slate-600">Control de ingresos y gastos operativos de la empresa.</p>
          </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card className="shadow-md border-slate-200">
                <CardHeader className="pb-3">
                  <CardTitle className="text-lg font-bold">Ingresos del Mes</CardTitle>
