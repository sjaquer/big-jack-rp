...
5. Deja que el ERP maneje el resto del flujo operativo asociado a la venta.

Nota: este webhook no descuenta stock ni registra movimientos de inventario de forma manual. Esa lógica queda del lado del ERP.
